...
const now = dayjs();
const n7 = now.add(7, 'days');
const n3 = now.add(3, 'days');
const n1 = now.add(1, 'days');

const n7Formatted = n7.format('dddd, MMMM D');
const n3Formatted = n3.format('dddd, MMMM D');
const n1Formatted = n1.format('dddd, MMMM D');


function rendeerOrderSummary() {
